...
#
# This script:
# 1) Loads and cleans 2023 EIA-923 YTD data (Group3Data.csv)
# 2) Creates an efficiency feature (MMBtu per MWh)
# 3) Scales variables for clustering
# 4) Splits into train/test (75/25) per the assignment
# 5) Uses elbow and silhouette methods to pick k
# 6) Runs k-means with k = 3
# 7) Summarizes and visualizes the clusters
